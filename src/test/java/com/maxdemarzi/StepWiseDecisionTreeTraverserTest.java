...
public class StepWiseDecisionTreeTraverserTest {
    ...
    private static final Map QUERY1 =
            singletonMap("statements", singletonList(singletonMap("statement",
                    "CALL com.maxdemarzi.stepwise.decision_tree('bar entrance', {gender:'male', age:'20'}) yield path return path")));
    ...
    private static final Map QUERY2 =
            singletonMap("statements", singletonList(singletonMap("statement",
                    "CALL com.maxdemarzi.stepwise.decision_tree('bar entrance', {gender:'female', age:'19'}) yield path return path")));
    ...
    private static final Map QUERY3 =
            singletonMap("statements", singletonList(singletonMap("statement",
                    "CALL com.maxdemarzi.stepwise.decision_tree('bar entrance', {gender:'male', age:'23'}) yield path return path")));
    ...
    private static final Map QUERY4 =
            singletonMap("statements", singletonList(singletonMap("statement",
                    "CALL com.maxdemarzi.stepwise.decision_tree('bar entrance', {}) yield path return path")));
    ...
    private static final Map QUERY5 =
            singletonMap("statements", singletonList(singletonMap("statement",
                    "CALL com.maxdemarzi.stepwise.decision_tree('bar entrance', {age:'20'}) yield path return path")));
    ...
    private static final Map QUERY6 =
            singletonMap("statements", singletonList(singletonMap("statement",
                    "CALL com.maxdemarzi.stepwise.decision_tree('bar entrance', {gender:'female'}) yield path return path")));
    ...
    private static final Map SQUERY1 =
            singletonMap("statements", singletonList(singletonMap("statement",
                    "CALL com.maxdemarzi.stepwise.decision_tree('funeral', {answer_1:'yeah', answer_2:'yeah', answer_3:'yeah'}) yield path return path")));
    ...
    private static final Map SQUERY2 =
            singletonMap("statements", singletonList(singletonMap("statement",
                    "CALL com.maxdemarzi.stepwise.decision_tree('funeral', {answer_1:'what', answer_2:'', answer_3:''}) yield path return path")));
    ...
    private static final Map SQUERY3 =
            singletonMap("statements", singletonList(singletonMap("statement",
                    "CALL com.maxdemarzi.stepwise.decision_tree('funeral', {answer_1:'what', answer_2:'yeah', answer_3:'okay'}) yield path return path")));
    ...
    private static final Map SQUERY4 =
            singletonMap("statements", singletonList(singletonMap("statement",
                    "CALL com.maxdemarzi.stepwise.decision_tree('funeral', {}) yield path return path")));
    ...
    private static final Map SQUERY5 =
            singletonMap("statements", singletonList(singletonMap("statement",
                    "CALL com.maxdemarzi.stepwise.decision_tree('funeral', {answer_1:'what'}) yield path return path")));
